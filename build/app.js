...
var ExampleRandom = React.createClass({displayName: "ExampleRandom",
  render: function() {
    return (
      React.createElement(ReactGiphy, null)
    );
  }
});

React.render(React.createElement(ExampleRandom, null), document.getElementById('example-random'));


},{"../../":4,"react":160}],2:[function(require,module,exports){
var React = require('react');
var ReactGiphy = require('../../');

var ExampleSearch = React.createClass({displayName: "ExampleSearch",
  render: function() {
    return (
      React.createElement(ReactGiphy, {search: "game of thrones"})
    );
  }
});

React.render(React.createElement(ExampleSearch, null), document.getElementById('example-search'));


},{"../../":4,"react":160}],3:[function(require,module,exports){
var React = require('react');
var ReactGiphy = require('../../');

var ExampleTag = React.createClass({displayName: "ExampleTag",
  render: function() {
    return (
      React.createElement(ReactGiphy, {tag: "llama"})
    );
  }
});

React.render(React.createElement(ExampleTag, null), document.getElementById('example-tag'));


},{"../../":4,"react":160}],4:[function(require,module,exports){
var React = require('react');
...
},{"react":160,"superagent":161}],5:[function(require,module,exports){
...
require('./js/example-random');
require('./js/example-tag');
require('./js/example-search');


},{"./js/example-random":1,"./js/example-search":2,"./js/example-tag":3}]},{},[164]);
